...
const Config = function () {
  ...
  this.safeBrowsingApiEndpoint = getNPMConfig(['safe_browsing_api_endpoint']) || 'safebrowsing.google.com'
...
Config.prototype.buildArgs = function () {
  ...
  let args = {
    ...
    // Replace the 'dummytoken' with your API key to use Google APIs such as SafeBrowsing APIs
    // Read more here: https://www.chromium.org/developers/how-tos/api-keys
    // google_api_key: "dummytoken",
